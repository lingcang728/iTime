...
.weekly-apps__rank { color: var(--text-muted); font-size: var(--text-micro); font-variant-numeric: tabular-nums; }
.weekly-apps__name { min-width: 0; display: grid; gap: 2px; }
.weekly-apps__name strong { overflow: hidden; color: var(--text-primary); font-size: var(--text-micro); font-weight: 560; text-overflow: ellipsis; white-space: nowrap; }
.weekly-apps__name small { overflow: hidden; color: var(--text-muted); font-size: var(--text-micro); text-overflow: ellipsis; white-space: nowrap; }
...
.weekly-apps em { color: var(--text-secondary); font-size: var(--text-micro); font-style: normal; font-variant-numeric: tabular-nums; white-space: nowrap; }
.weekly-apps__empty { min-height: 110px; display: grid; place-items: center; color: var(--text-muted); font-size: var(--text-micro); }
