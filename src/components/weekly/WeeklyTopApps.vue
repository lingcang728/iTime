...
.weekly-apps__rank { color: var(--text-muted); font-size: 9px; font-variant-numeric: tabular-nums; }
...
.weekly-apps__name small { overflow: hidden; color: var(--text-muted); font-size: 8px; text-overflow: ellipsis; white-space: nowrap; }
.weekly-apps em { color: var(--text-secondary); font-size: 9px; font-style: normal; font-variant-numeric: tabular-nums; white-space: nowrap; }
.weekly-apps__empty { min-height: 110px; display: grid; place-items: center; color: var(--text-muted); font-size: 9px; }
