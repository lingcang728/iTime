...
import { PhBookOpenText, PhCode, PhFolders, PhMicrophone, PhRobot, PhVideoCamera } from '@phosphor-icons/vue'
...
export const categoryVisuals: Record<string, CategoryVisual> = {
  ...
  '语音输入': { icon: PhMicrophone, gradient: 'linear-gradient(90deg, #42aaa8, #73cfca)', iconTone: '#45aaa8' },
