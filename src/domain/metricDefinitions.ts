...
export const metricDefinitions: Record<MetricDefinitionId, MetricDefinition> = {
  ...
  providerCoverage: {
    name: 'Provider 执行覆盖',
    formula: '获授权 Provider 执行区间的自然时间并集',
    unit: 'milliseconds',
    window: '所选本地自然日',
    missing: '暂无获授权 Provider 数据',
  },
  aiLeverage: {
    name: 'AI 杠杆率',
    formula: 'Provider 累计执行时长 ÷ AI 前台活跃时长',
    unit: 'ratio',
    window: '所选本地自然日',
    missing: '缺少 Provider 执行或 AI 前台活跃分母',
  },
  providerParallelRatio: {
    name: 'Provider 并行占比',
    formula: '前台专注与 Provider 执行重叠时长 ÷ Provider 执行覆盖时长',
    unit: 'ratio',
    window: '所选本地自然日',
    missing: '缺少 Provider 覆盖或前台专注数据',
  },
  providerConcurrency: {
    name: 'Provider 最高并发',
    formula: '获授权 Provider 执行区间在同一时刻的最大重叠数量',
    unit: 'count',
    window: '所选本地自然日',
    missing: '暂无获授权 Provider 数据',
  },
